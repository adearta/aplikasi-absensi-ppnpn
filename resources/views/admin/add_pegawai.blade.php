...
<div class="container mt-4">
  ...
  <input type="text" id="nik" class="form-control @error('nik') is-invalid @enderror" placeholder="masukkan NIK" value="{{ old('nik') }}" name="nik">
  @error('nik')
  ...
  <input type="text" id="namaPegawai" class="form-control @error('namaPegawai') is-invalid @enderror" placeholder="masukkan nama pegawai" value="{{ old('namaPegawai') }}" name="namaPegawai">
  @error('namaPegawai')
    <div class="alert alert-danger mt-2">
      {{ $message }}
    </div>
...
<div class="mb-3">
  ...
  <input type="number" class="form-control @error('usia') is-invalid @enderror" id="usia" placeholder="masukkan usia" value="{{ old('usia') }}" name="usia">
  @error('usia')
    <div class="alert alert-danger mt-2">
      {{ $message }}
    </div>
...
<div class="mb-3">
  ...
  <input type="text" class="form-control @error('alamat') is-invalid @enderror" id="alamat" placeholder="masukkan alamat" value="{{ old('alamat') }}" name="alamat">
  @error('alamat')
    <div class="alert alert-danger mt-2">
      {{ $message }}
    </div>
...
<div class="mb-3">
  ...
  <input type="number" class="form-control @error('lamaBekerja') is-invalid @enderror" id="lamaBekerja" placeholder="masukkan lama kerja" value="{{ old('lamaBekerja') }}" name="lamaBekerja">
  @error('lamaBekerja')
    <div class="alert alert-danger mt-2">
      {{ $message }}
    </div>
...
<div class="mb-3">
  ...
  <input type="number" class="form-control @error('gaji') is-invalid @enderror" id="gaji" placeholder="masukkan gaji" value="{{ old('gaji') }}" name="gaji">
  @error('gaji')
    <div class="alert alert-danger mt-2">
      {{ $message }}
    </div>
